	...
	render(){
		return(
			<div className="contact">
				<h2>{consts.OUR_CONTACTS}</h2>
				<div  className="info-karta">
					<div className="info-contacts">
						<p><label>{consts.ADDRESS}:</label> Abylay khan, 140</p>
						<p><label>{consts.TELEPHONE}:</label> 8 (727) 222 5525</p>
						<p><label>{consts.WORKING_HOURS}:</label> 09:00 - 19:00</p>
						<p>
							<label>{consts.WEB_PAGE}:</label>
